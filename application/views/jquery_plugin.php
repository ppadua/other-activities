...
<head>
	...
	<script src="/assets/jquery_plugin/js/scripts/jquery.hideo.js?<?= time()?>"></script>
	<script src="/assets/jquery_plugin/js/scripts/jquery.haruki.js?<?= time()?>"></script>
	...
	<link rel="stylesheet" href="/assets/asana/css/vendor/font-awesome/font-awesome.min.css?<?= time()?>">

	<link rel="stylesheet" href="/assets/jquery_plugin/css/jquery.hideo.css?<?= time()?>">
	<link rel="stylesheet" href="/assets/jquery_plugin/css/jquery.haruki.css?<?= time()?>">
	<link rel="stylesheet" href="/assets/jquery_plugin/css/jquery.hoshi.css?<?= time()?>">
	<link rel="stylesheet" href="/assets/jquery_plugin/css/jquery.juro.css?<?= time()?>">
	<link rel="stylesheet" href="/assets/jquery_plugin/css/jquery.madoka.css?<?= time()?>">
</head>
<body>
	<input type="text" name="" class="madokaw">
