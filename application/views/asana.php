...
<head>
	<meta charset="UTF-8">
	<title>Asana</title>
	<link rel="stylesheet" href="../assets/asana/css/custom/dashboard.css">
	<link rel="stylesheet" href="../assets/asana/css/custom/global.css">
	<link rel="stylesheet" href="../assets/asana/css/vendor/bootstrap/bootstrap.min.css">
	<link rel="stylesheet" href="../assets/asana/css/vendor/bootstrap-select/bootstrap-select.min.css">
	<link rel="stylesheet" href="../assets/asana/css/vendor/font-awesome/font-awesome.min.css">
    <link rel="stylesheet" href="../assets/asana/css/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.css">

	<script src="../assets/asana/js/vendor/jquery/jquery-3.2.1.slim.min.js"></script>
	<script src="../assets/asana/js/vendor/jquery/jquery.js"></script>
	<script src="../assets/asana/js/vendor/jquery/jquery-ui.js"></script>
	<script src="../assets/asana/js/vendor/bootstrap/bootstrap.min.js"></script>
	<script src="../assets/asana/js/vendor/bootstrap-select/bootstrap-select.min.js"></script>
 	<script src="../assets/asana/js/vendor/moment/moment.js"></script>
    <script src="../assets/asana/js/vendor/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js"></script>
 	<script src="../assets/asana/js/vendor/underscore/underscore.min.js"></script>
	<script src="../assets/asana/js/custom/global.js"></script>
	<script src="../assets/asana/js/custom/dashboard.js"></script>
</head>
<body>
	<div id="wrapper">
